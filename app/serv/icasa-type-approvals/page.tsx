          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                Expert guidance for ICASA type approval applications. We handle
                Standard, Simplified, Tested, and Untested approvals with a
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                requires all electronic communication equipment to be
                type-approved before being sold or used in South Africa. This
                ensures devices meet regulatory, technical, and safety
                standards.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Our team simplifies this complex process, handling all
                documentation, testing coordination, and regulatory
                communications to ensure your products reach the market quickly
                and compliantly.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer comprehensive support for all types of ICASA type
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A proven 5-step process that ensures your ICASA type approval is
              successful
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> A technology company wanted to import
                a new range of wireless routers into South Africa.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They needed ICASA type approval but
                were unfamiliar with the regulatory requirements and
                documentation process.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert managed their ICASA type
                approval application from start to finish, ensuring compliance
                and timely market entry.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The company received approval 30%
                faster than industry average, allowing them to launch their
                products on schedule and capture market opportunities.
              </p>
            </div>
          </div>
        </div>
