          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                Expert guidance for Class Electronic Communications Service
                (ECS) and Electronic Communications Network Service (ECNS)
                licensing. We handle the entire process from assessment to
                approval.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Businesses providing electronic communications services or
                network infrastructure may require a Class Electronic
                Communications Service (ECS) or Electronic Communications
                Network Service (ECNS) license from ICASA. Without the
                appropriate license, your operations could be at risk of
                non-compliance, fines, or shutdowns.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                We simplify the licensing process, ensuring your business
                remains compliant while you focus on innovation and growth.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Determining whether your business needs a Class ECS or ECNS
                license
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Keeping your license valid and up to date
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> A startup launching a VoIP
                communication platform needed an ECS license to operate legally.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They were unfamiliar with
                ICASA&apos;s licensing requirements and needed guidance on the
                application process.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert assessed their needs, filed
                their application, and ensured they met ICASA&apos;s operational
                requirements.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The startup received their ECS license
                efficiently, allowing them to launch their VoIP platform legally
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200">
            Ensure your business stays compliant with an ECS or ECNS license
            from Bilacert. Let us handle the licensing process so you can focus
            on delivering exceptional services.
          </p>
