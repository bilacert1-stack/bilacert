          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                Expert guidance for ECS/ECNS license exemptions. We help
                determine if your business qualifies for exemptions and provide
                the necessary documentation for compliance assurance.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Operate without licensing delays
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Not all businesses providing electronic communications services
                or infrastructure require an ICASA ECS (Electronic
                Communications Service) or ECNS (Electronic Communications
                Network Service) license. Some may qualify for an ICASA License
                Exemption, allowing them to operate legally without the need for
                a full licensing process.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                However, determining whether your business qualifies for an
                exemption can be complex. We simplify the process, ensuring you
                have the right exemption in place to avoid unnecessary costs and
                compliance risks.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer a structured approach to securing and maintaining your
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Preparing the necessary documents to support your exemption
                claim
              </p>
            </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> A software company offering
                cloud-based VoIP services assumed they needed an ECS license.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They were unsure about their
                licensing requirements and wanted to avoid unnecessary costs and
                regulatory hurdles.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert assessed their operations
                and confirmed they qualified for an exemption, saving them
                licensing costs.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The company now operates legally under
                an exemption, avoiding unnecessary licensing fees while
                maintaining full compliance with ICASA regulations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200">
            Ensure your business qualifies for an ECS/ECNS exemption with our
            expert guidance. Avoid unnecessary licensing and operate with
            confidence through our seamless process.
          </p>
