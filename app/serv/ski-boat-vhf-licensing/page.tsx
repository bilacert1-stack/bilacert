          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                Expert guidance for Ski Boat VHF Radio licensing. We handle
                vessel assessment, application preparation, ICASA liaison, and
                ensure compliance with maritime communication regulations.
              </p>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      ICASA maritime regulations specialist
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                In South Africa, ski boats and other vessels using VHF radios
                for marine communication are required to have a valid VHF Radio
                License from ICASA. This ensures that all maritime radio
                communication remains safe, legal, and interference-free.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                We simplify the process of obtaining your Ski Boat VHF License,
                ensuring compliance with ICASA regulations while allowing you to
                focus on your boating experience.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer a full-service approach to obtaining and maintaining your
              VHF Radio License
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Helping vessel owners stay compliant with maritime radio
                regulations
              </p>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> A fishing charter company needed
                multiple VHF licenses for its fleet of boats.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They needed to ensure all vessels
                were legally compliant before peak season and were unfamiliar
                with the licensing process.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert managed the entire process,
                ensuring all vessels were legally compliant with maritime
                regulations.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The charter company received all their
                VHF licenses efficiently, allowing them to operate legally
                during peak season without any compliance issues.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200">
            Ensure your vessel stays compliant with a Ski Boat VHF License from
            Bilacert. Let us handle the licensing process so you can enjoy safe
            and legal marine communication.
          </p>
