          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                Expert guidance for NRCS LOA applications. We handle product
                eligibility assessment, technical documentation, testing
                coordination, and ensure smooth approval processes.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                mandates that certain electrical and electronic products must
                receive a Letter of Authority (LOA) before entering the South
                African market. This certification ensures products meet South
                African safety and quality standards.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Our team streamlines the NRCS LOA application process, ensuring
                businesses obtain approvals efficiently while staying fully
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer a full-service solution to obtaining and maintaining NRCS
              LOA certification
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Determining if your product requires an LOA
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Arranging third-party testing where necessary
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> An electronics importer wanted to
                bring in a new range of LED lighting products but was unaware of
                NRCS LOA requirements.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They needed an LOA but lacked the
                technical knowledge and documentation required for NRCS
                compliance.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert confirmed the LOA
                requirement, handled their submission, and ensured a smooth
                approval process.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The company received their NRCS LOA
                efficiently, allowing them to import and sell their LED products
                legally in South Africa without delays.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200">
            ...
            Avoid costly delays and regulatory risks with our seamless approval
            process.
          </p>
