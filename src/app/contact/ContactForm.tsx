  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-20">
        <Image src="/herosetion/Contact-Us.jpg" alt="Get in touch" fill priority className="object-cover" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-2">info@bilacert.com</p>
      ...
      <section className="py-20 bg-secondary-gray">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            For urgent compliance matters, call us directly at 075 430 4433 
            or reach out via WhatsApp for instant support.
          </p>
