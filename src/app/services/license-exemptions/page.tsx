...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Expert ECS/ECNS license exemption services for South African businesses. We help determine if your business qualifies for ICASA license exemptions and provide compliance documentation.',
    url: 'https://bilacert.com/services/license-exemptions',
    type: 'website',
  },
  alternates: {
    canonical: 'https://bilacert.com/services/license-exemptions',
  },
};
...
export default function LicenseExemptionsPage() {
  ...
  const process = [
    ...
    },
    {
      ...
      description: 'Once verified, we provide you with the necessary documentation to prove your exemption status.'
    },
    {
      step: '5',
      title: 'Ongoing Compliance Monitoring',
      description: 'We track regulatory changes to ensure your exemption remains valid and your business stays compliant.'
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-20">
        <Image src="/license-exemptions.jpg" alt="License Exemptions" fill priority className="object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                ...
                qualifies for exemptions and provide the necessary documentation for compliance assurance.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Not all businesses providing electronic communications services or infrastructure require 
                an ICASA ECS (Electronic Communications Service) or ECNS (Electronic Communications Network Service) 
                license. Some may qualify for an ICASA License Exemption, allowing them to operate legally 
                without the need for a full licensing process.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                However, determining whether your business qualifies for an exemption can be complex. 
                We simplify the process, ensuring you have the right exemption in place to avoid unnecessary 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer a structured approach to securing and maintaining your ICASA license exemption
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Assessing whether your business qualifies for an exemption</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Preparing the necessary documents to support your exemption claim</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Obtaining formal confirmation from ICASA when required</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Ensuring your business remains exempt as regulations evolve</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> A software company offering cloud-based VoIP services assumed they needed an ECS license.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They were unsure about their licensing requirements and wanted to avoid unnecessary costs and regulatory hurdles.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert assessed their operations and confirmed they qualified for an exemption, saving them licensing costs.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The company now operates legally under an exemption, avoiding unnecessary licensing fees while maintaining full compliance with ICASA regulations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200">
            Ensure your business qualifies for an ECS/ECNS exemption with our expert guidance. 
            Avoid unnecessary licensing and operate with confidence through our seamless process.
          </p>
