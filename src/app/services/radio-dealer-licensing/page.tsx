...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Complete Radio Dealer License services for South African businesses selling radio communication equipment. Expert ICASA licensing support and compliance guidance.',
    url: 'https://bilacert.com/services/radio-dealer-licensing',
    type: 'website',
  },
  alternates: {
    canonical: 'https://bilacert.com/services/radio-dealer-licensing',
  },
};
  ...
  const process = [
    {
      ...
      description: 'We assess whether your business requires a Radio Dealer License and identify necessary documentation.'
    },
    {
      step: '2',
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-20">
        <Image src="/herosetion/Radio-Dealer.jpg" alt="Radio Dealer Licensing" fill priority className="object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                Expert guidance for Radio Dealer License applications. We handle eligibility assessment, 
                documentation preparation, ICASA liaison, and ongoing compliance support.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Any business that sells, distributes, or supplies radio communication equipment in South Africa 
                must hold a valid Radio Dealer License issued by ICASA. Without this license, trading in such 
                equipment is illegal and can result in hefty fines or business disruptions.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Required for radio communication equipment sales</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer a full-service approach to obtaining and maintaining your Radio Dealer License
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Determining whether your business requires a Radio Dealer License</p>
            </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> A two-way radio distributor was unaware of the ICASA licensing requirements and faced operational risks.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They needed a Radio Dealer License urgently to avoid business disruption and legal penalties.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert swiftly secured their Radio Dealer License, ensuring they could continue trading legally.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The distributor now operates without disruptions, maintaining full compliance with ICASA regulations and avoiding costly penalties.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200">
            Ensure your business stays compliant with a Radio Dealer License from Bilacert. 
            Let us handle the licensing process so you can focus on what you do best.
          </p>
