...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Professional VHF radio licensing services for South African marine vessels including ski boats, yachts, and recreational watercraft. Expert ICASA maritime compliance support.',
    url: 'https://bilacert.com/services/ski-boat-vhf-licensing',
    type: 'website',
  },
  alternates: {
    canonical: 'https://bilacert.com/services/ski-boat-vhf-licensing',
  },
};
...
export default function SkiBoatVHFLicensingPage() {
  ...
  const process = [
    {
      ...
      description: 'We assess whether your ski boat or vessel requires a VHF license and identify necessary documentation.'
    },
    {
      step: '2',
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'We ensure your application meets all ICASA requirements for maritime communication.'
    },
    {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-20">
        <Image src="/herosetion/Ski-Boat-VHF.jpg" alt="Ski Boat VHF Licensing" fill priority className="object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                ...
                application preparation, ICASA liaison, and ensure compliance with maritime communication regulations.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                In South Africa, ski boats and other vessels using VHF radios for marine communication 
                are required to have a valid VHF Radio License from ICASA. This ensures that all 
                maritime radio communication remains safe, legal, and interference-free.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Confirming if your vessel requires a VHF license</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Helping vessel owners stay compliant with maritime radio regulations</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> A fishing charter company needed multiple VHF licenses for its fleet of boats.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They needed to ensure all vessels were legally compliant before peak season and were unfamiliar with the licensing process.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert managed the entire process, ensuring all vessels were legally compliant with maritime regulations.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The charter company received all their VHF licenses efficiently, allowing them to operate legally during peak season without any compliance issues.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Ready to Get Your VHF License?
          </h2>
          <p className="text-xl mb-8 text-gray-200">
            Ensure your vessel stays compliant with a Ski Boat VHF License from Bilacert. 
            Let us handle the licensing process so you can enjoy safe and legal marine communication.
          </p>
