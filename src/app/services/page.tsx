  ...
  const services = [
    {
      ...
      description: 'Comprehensive support for ICASA type approval applications, including Standard, Simplified, Tested, and Untested approvals.',
      icon: <Award className="h-8 w-8" />,
      href: '/services/icasa-type-approvals',
      features: ['Standard Type Approval', 'Simplified Type Approval', 'Tested & Untested Approvals', 'Testing Coordination'],
      pricing: 'From R2,000'
    },
    {
      title: 'NRCS LOA Applications',
      description: 'Letter of Authority applications for electrical and electronic products requiring NRCS certification.',
    ...
    },
    {
      ...
      description: 'Complete licensing support for businesses selling or distributing radio communication equipment.',
    ...
    },
    {
      ...
      description: 'Electronic Communications Service and Network Service licensing for telecom providers.',
      icon: <Shield className="h-8 w-8" />,
      href: '/services/class-ecs-ecns-licensing',
      features: ['ECS License Applications', 'ECNS License Applications', 'Compliance Support', 'Renewals & Updates'],
      pricing: 'From R1,500'
    },
    {
      title: 'License Exemptions',
      description: 'Assessment and application support for businesses that may qualify for ICASA license exemptions.',
    ...
    },
    {
      ...
      description: 'VHF radio licensing for marine vessels, including ski boats and recreational watercraft.',
  ...
  const process = [
    {
      ...
      description: 'We assess your specific needs and determine the most appropriate compliance pathway.'
    },
    {
      step: '2',
      title: 'Documentation Review',
      description: 'We review and prepare all necessary documentation to ensure accuracy and completeness.'
    },
    {
      step: '3',
      title: 'Application Submission',
      description: 'We handle the entire submission process and manage all regulatory communications.'
    },
    {
      step: '4',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-200 max-w-4xl mx-auto">
              Comprehensive licensing and compliance solutions covering all aspects of 
              ICASA and NRCS regulatory approvals
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From initial consultation to final approval, we manage every step of your compliance journey
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We combine expertise, efficiency, and personalized support to deliver exceptional results
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our team has deep industry knowledge and regulatory expertise to guide you through complex compliance requirements.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We minimize delays by ensuring applications are complete and accurate the first time, with 30% faster processing than industry average.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                With a 100% success rate on first-time applications, you can trust us to deliver results that keep your business compliant.
              </p>
            </div>
          </div>
        </div>
