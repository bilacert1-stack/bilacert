...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Expert ICASA type approval services for South African businesses. We handle Standard, Simplified, Tested, and Untested approvals with fast processing and comprehensive support.',
    url: 'https://bilacert.com/services/icasa-type-approvals',
    type: 'website',
  },
  alternates: {
    canonical: 'https://bilacert.com/services/icasa-type-approvals',
  },
};
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-20">
        <Image src="/herosetion/Type-Approval.jpg" alt="ICASA Type Approvals" fill priority className="object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-200 mb-8">
                Expert guidance for ICASA type approval applications. We handle Standard, Simplified, 
                Tested, and Untested approvals with a proven track record of success.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                communication equipment to be type-approved before being sold or used in South Africa. 
                This ensures devices meet regulatory, technical, and safety standards.
              </p>
              <p className="text-lg text-gray-600 mb-8">
                Our team simplifies this complex process, handling all documentation, testing coordination, 
                and regulatory communications to ensure your products reach the market quickly and compliantly.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> A technology company wanted to import a new range of wireless routers into South Africa.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They needed ICASA type approval but were unfamiliar with the regulatory requirements and documentation process.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert managed their ICASA type approval application from start to finish, ensuring compliance and timely market entry.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The company received approval 30% faster than industry average, allowing them to launch their products on schedule and capture market opportunities.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200">
            Let our experts guide you through the ICASA type approval process. 
            Get a free consultation and start your compliance journey today.
          </p>
