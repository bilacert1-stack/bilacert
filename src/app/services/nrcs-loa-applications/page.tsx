...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Professional NRCS Letter of Authority (LOA) application services for South African businesses. Expert guidance for electrical and electronic product compliance.',
    url: 'https://bilacert.com/services/nrcs-loa-applications',
    type: 'website',
  },
  alternates: {
    canonical: 'https://bilacert.com/services/nrcs-loa-applications',
  },
};
...
export default function NRCSLOAApplicationsPage() {
  const servicePlans = [
    ...
    },
    {
      ...
      features: ['Full documentation preparation', 'NRCS submission', 'Liaison & tracking', 'Testing coordination'],
      price: 'R7,000',
      popular: true
    },
    {
      ...
      features: ['Complete end-to-end service', 'Testing coordination', 'Ongoing compliance support', 'Priority processing'],
      price: 'R10,500',
      popular: false
    }
  ];
  ...
  const process = [
    ...
    },
    {
      ...
      description: 'Once approved, we deliver your NRCS LOA certificate and provide ongoing compliance support.'
    }
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Our team understands NRCS requirements and ensures applications meet all standards.'
    },
    {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-20">
        <Image src="/NRCS.jpg" alt="NRCS LOA" fill priority className="object-cover" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <h3 className="text-lg font-semibold text-primary mb-2">Product Eligibility Assessment</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Ensuring compliance with safety and quality standards</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Managing submissions and tracking approval status</p>
            </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> An electronics importer wanted to bring in a new range of LED lighting products but was unaware of NRCS LOA requirements.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They needed an LOA but lacked the technical knowledge and documentation required for NRCS compliance.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert confirmed the LOA requirement, handled their submission, and ensured a smooth approval process.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The company received their NRCS LOA efficiently, allowing them to import and sell their LED products legally in South Africa without delays.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6">
            Ready to Get Your NRCS LOA?
          </h2>
          <p className="text-xl mb-8 text-gray-200">
            Ensure your products are NRCS-certified with our expert guidance. 
            Avoid costly delays and regulatory risks with our seamless approval process.
          </p>
