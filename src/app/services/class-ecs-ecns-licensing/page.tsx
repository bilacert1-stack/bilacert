...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Professional ECS and ECNS licensing services for South African telecommunications providers. Expert guidance for Electronic Communications Service and Network Service licenses.',
    url: 'https://bilacert.com/services/class-ecs-ecns-licensing',
    type: 'website',
  },
  alternates: {
    canonical: 'https://bilacert.com/services/class-ecs-ecns-licensing',
  },
};
...
export default function ClassECSECNSLicensingPage() {
  ...
  const process = [
    {
      ...
      description: 'We assess whether your business requires a Class ECS or ECNS license and identify necessary documentation.'
    },
    {
      step: '2',
      title: 'Application Preparation',
      description: 'Our experts compile, review, and prepare all required documents for complete and accurate submission.'
    },
    {
      step: '3',
      title: 'Submission & ICASA Liaison',
      description: 'We submit the application and manage all interactions with ICASA to streamline the approval process.'
    },
    {
      step: '4',
    ...
    },
    {
      ...
      description: 'We provide ongoing support for license renewals, amendments, and regulatory compliance updates.'
    }
  ];
  ...
  const licenseTypes = [
    {
      title: 'ECS License',
      description: 'Electronic Communications Service license allows businesses to provide electronic communication services without owning the infrastructure.',
      icon: <FileText className="h-6 w-6" />
    },
    {
      title: 'ECNS License',
      description: 'Electronic Communications Network Service license allows businesses to build and operate network infrastructure.',
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative text-white py-20">
        <Image src="/class-ens-ecns.jpg" alt="Class ECS ECNS Licensing" fill priority className="object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Businesses providing electronic communications services or network infrastructure may require 
                a Class Electronic Communications Service (ECS) or Electronic Communications Network Service (ECNS) 
                license from ICASA. Without the appropriate license, your operations could be at risk of 
                non-compliance, fines, or shutdowns.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Required for electronic communication services</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-accent" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer a full-service approach to obtaining and maintaining your ICASA Class ECS/ECNS license
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Determining whether your business needs a Class ECS or ECNS license</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Ensuring all required paperwork is accurate and complete</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Managing all interactions with ICASA for smooth approval</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {servicePlans.map((plan, index) => (
              <div key={index} className={`bg-white p-8 rounded-xl shadow-sm relative ${plan.popular ? 'ring-2 ring-accent' : ''}`}>
                {plan.popular && (
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 mb-4">
                <strong>Scenario:</strong> A startup launching a VoIP communication platform needed an ECS license to operate legally.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Challenge:</strong> They were unfamiliar with ICASA&apos;s licensing requirements and needed guidance on the application process.
              </p>
              <p className="text-gray-600 mb-4">
                <strong>Solution:</strong> Bilacert assessed their needs, filed their application, and ensured they met ICASA&apos;s operational requirements.
              </p>
              <p className="text-gray-600">
                <strong>Result:</strong> The startup received their ECS license efficiently, allowing them to launch their VoIP platform legally and focus on growing their business.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary-light text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-gray-200">
            Ensure your business stays compliant with an ECS or ECNS license from Bilacert. 
            Let us handle the licensing process so you can focus on delivering exceptional services.
          </p>
